import { Flag, Maze } from './Classes.js';
...
// adding the player inside the maze
...
// add the count of flags for that particular room
...
// remove the current flag from data model
